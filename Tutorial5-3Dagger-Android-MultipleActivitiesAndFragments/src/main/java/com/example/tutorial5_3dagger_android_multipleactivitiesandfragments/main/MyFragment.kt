...
class MyFragment : DaggerFragment() {
    ...
    /**
     * Injected from [MyFragmentModule] with @FragmentScope which
   ...
   lateinit var toastMaker: ToastMaker
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("🥶 MyFragment mySharedPreferences: $mySharedPreferences")
        println("🥶 MyFragment sharedPreferences: $sharedPreferences")
        println("🥶 MyFragment toastMaker: $toastMaker")
